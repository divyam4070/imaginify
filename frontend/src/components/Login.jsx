...
export default function Login() {
  ...
  return (
    <motion.div className="fixed absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
      ...
      className="relative bg-white p-10 rounded-xl text-slate-500">
        ...
        <p className="text-sm uppercase">Welcome back! Please sign in to continue</p>
        ...
        <img onClick={()=>setShowLogin(false)} src={assets.cross_icon} alt="cross" className="absolute top-5 right-5 cursor-pointer" />
      </motion.form>
    </motion.div>
  );
}
